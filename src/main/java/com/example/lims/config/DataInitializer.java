...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (authorRepository.count() > 0) {
            System.out.println("База данных уже заполнена. Пропускаем инициализацию.");
            return;
        }
        ...
        User admin = new User("Иван", "Иванов", "Иванович", "admin@lims.com", UserRole.ADMIN, "LIB-0001");
        User reader = new User("Петр", "Петров", "Сергеевич", "petr@test.com", UserRole.READER, "LIB-0002");
